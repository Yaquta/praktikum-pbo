...
public class main {
    public static void main(String[] args) {
       ...
       //membuat objek wali mahasiswa
        ...
        Mahasiswa mahasiswa1 = new Mahasiswa("Iwan Merdu", "24060122130078", "Informatika", wali1);
        Mahasiswa mahasiswa2 = new Mahasiswa("Sally Cinnamon", "24060122140088", "Informatika", wali2);
        Mahasiswa mahasiswa3 = new Mahasiswa("Lemmy Skinnyhead", "240601221200001", "Informatika", wali1);
